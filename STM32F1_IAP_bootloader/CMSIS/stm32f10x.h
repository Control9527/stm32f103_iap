 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
  ...
  */           
#if !defined  HSE_VALUE   /////不同外部晶振，修改其值
 #ifdef STM32F10X_CL                                                                       // 外部晶振
  #define HSE_VALUE    ((uint32_t)25000000) /*!< Value of the External oscillator in Hz */ // 25Mz
 #else 
  #define HSE_VALUE    ((uint32_t)8000000) /*!< Value of the External oscillator in Hz */  // 8Mz
 #endif /* STM32F10X_CL */
#endif /* HSE_VALUE */
